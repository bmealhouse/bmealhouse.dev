...
export const BackToTopRocket = () => {
  ...
  let transition =
    "transition-transform translate-y-0 scale-100 ease-in duration-200";
  if (scrollPosition < 500) {
    transition =
      "transition-transform translate-y-24 scale-50 ease-out duration-200";
  }

  return (
    <div
      className={`fixed bottom-7 right-6 w-10 h-10 p-2 text-gray-800 bg-yellow-200 hover:bg-yellow-300 rounded-md transform -rotate-45 cursor-pointer ${transition}`}
      onClick={() => {
